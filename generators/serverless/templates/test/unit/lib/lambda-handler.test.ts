...
describe('AwsLambdaHandler', () => {
  ...
  describe('detectEventSource', () => {
    ...
    it('should return AwsLambdaInvoker.SERVERLESS_OFFLINE when the event has properties requestContext.accountId = "offlineContext_accountId"', () => {
      const event = {
        requestContext: {
      ...
      eventSource.should.be.equal(AwsLambdaInvoker.SERVERLESS_OFFLINE)
    })
